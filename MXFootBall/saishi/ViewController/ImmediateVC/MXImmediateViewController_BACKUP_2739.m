...
//        [parameters setObject:token forKey:@"token"] ;
    ...
    if ([defaults valueForKey:@"AllAsianPlateKey"] != nil) {
        NSMutableArray * array =[NSMutableArray arrayWithArray:[[defaults valueForKey:@"AllAsianPlateKey"] componentsSeparatedByString:@"|"]]  ;
    ...
    if ([defaults valueForKey:@"AllScreeningKey"] != nil) {
        NSMutableArray * array =[NSMutableArray arrayWithArray:[[defaults valueForKey:@"AllScreeningKey"] componentsSeparatedByString:@"|"]]  ;
...
//        [parameters setValue:array forKey:@"eventList"] ;
    }
    [parameters setObject:((self.status == 8) ? @"1":@"0") forKey:@"opid"] ;
...
//                NSLog(@"赛事🚗==%@",dic[@"data"]);
//                self.webURL = @"cvbjnop" ;
>>>>>>> 93681b88feb590eb335978359c571390f6e1d1af
