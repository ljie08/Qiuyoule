//
//  MXCompetitionScreeningViewController.m
//  MXFootBall
//
...
#import "MXCompetitionScreeningViewController.h"
...
@interface MXCompetitionScreeningViewController ()<UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout>
...
@implementation MXCompetitionScreeningViewController
...
- (void)getNetworkData {
    ...
    [parameters setObject:self.optType forKey:@"opid"];
        [parameters setObject:@"2" forKey:@"operationType"] ;
...
- (void)tongzhi:(NSNotification *)notification{
    ...
    if ([notification.userInfo[@"selectIndex"] isEqualToString:@"1"]) {
        //        isUnselectAll = YES ;
