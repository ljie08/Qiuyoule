//
//  MXFootballLotteyScreeningViewController.m
//  MXFootBall
//
...
#import "MXFootballLotteyScreeningViewController.h"
...
@interface MXFootballLotteyScreeningViewController ()<UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout>
{
    BOOL isUnselectAll ;
}
...
@implementation MXFootballLotteyScreeningViewController
...
//        [parameters setObject:token forKey:@"token"];
    ...
    [parameters setObject:@"4" forKey:@"operationType"] ;
...
- (void)tongzhi:(NSNotification *)notification{
    ...
    if ([notification.userInfo[@"selectIndex"] isEqualToString:@"3"]) {
        //        isUnselectAll = YES ;
