...
#import "NSTimer+MXSYJTimer.h"

static NSTimeInterval const kFastTimeInterval = 0.03;


@implementation MXSYJProgressLayer {
    CAShapeLayer *_layer;
...
+ (instancetype)layerWithFrame:(CGRect)frame {
    MXSYJProgressLayer *layer = [self new];
    layer.frame = frame;
...
- (void)initialize {
    ...
    _timer = [NSTimer syj_scheduledTimerWithTimeInterval:kFastTimeInterval repeats:YES block:^(NSTimer *timer) {
