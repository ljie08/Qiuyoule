...
@interface imageUrlModelColl : NSObject

@property (nonatomic,copy) NSString *imgUrl;//任务规则id

@end
@interface MXssCollectionModel : NSObject
...
@property (nonatomic, strong) NSMutableArray<imageUrlModelColl *> *forumImgs;
