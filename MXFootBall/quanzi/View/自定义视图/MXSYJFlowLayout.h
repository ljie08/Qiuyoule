...
@class MXSYJFlowLayout;

@protocol SYJWaterfallLayoutDelegate <NSObject>
...
@interface MXSYJFlowLayout : UICollectionViewFlowLayout
...
//代理，用来计算item的高度
@property (nonatomic, weak) id<SYJWaterfallLayoutDelegate> delegate;
